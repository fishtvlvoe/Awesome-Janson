# dashboard-local-connector Specification

## Purpose

TBD - created by archiving change 'cloud-dashboard-local-connector'. Update Purpose after archive.
...
<!-- @trace
source: cloud-dashboard-local-connector
updated: 2026-08-22
code:
  ...
  - scripts/live_connector_e2e.py
  - .github/prompts/spectra-commit.prompt.md
  - .opencode/commands/spectra-ask.md
  - scripts/local_connector.py
  ...
  - .spectra.yaml
  - scripts/local_connector_protocol.py
  ...
  - cloudflare/connector-room/worker.js
  - GEMINI.md
  - .github/prompts/spectra-ingest.prompt.md
  - .opencode/commands/spectra-archive.md
  - .opencode/commands/spectra-apply.md
  - cloudflare/connector-room/wrangler.toml
...
tests:
  - tests/test_local_connector_runtime.py
  - tests/test_local_connector_protocol.py
-->
